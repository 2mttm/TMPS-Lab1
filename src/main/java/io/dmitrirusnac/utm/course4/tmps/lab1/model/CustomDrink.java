...
public class CustomDrink implements Drink {
    ...
    public DrinkType getBaseType() {
        return baseType;
    }

    public int getIceAmountGrams() {
        return iceAmountGrams;
    }

    public int getSugarAmountGrams() {
        return sugarAmountGrams;
    }

    public int getMilkAmountMilliliters() {
        return milkAmountMilliliters;
    }
}
